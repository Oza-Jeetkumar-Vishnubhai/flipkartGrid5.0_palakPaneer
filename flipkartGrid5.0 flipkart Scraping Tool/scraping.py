        ...
        for web_link in list_of_url:
            ...
            for div in mydiv:
                ...
                new_row = pd.DataFrame({
                    ...
                    'brand': [brand_ls],
                    'title': [title_ls],
                    'sold_price': [current_price_ls],
                    'actual_price': [actual_price_ls],
                    'url': [url_ls],
                    'img': [img_ls]
                })
                ...
                try:
                    ...
                    urllib.request.urlretrieve(img_ls, f'images/{title_ls}.png')  # download and save image
                    ...
                    df = df.append({'id': counter, 'brand': brand_ls, 'title': title_ls, 'sold_price': current_price_ls,
                                    'actual_price': actual_price_ls, 'url': url_ls, 'img': img_ls}, ignore_index=True)
                    # df.to_csv('Data.csv')
...
lets_scrap_it(all_url)  # lets_compress()
